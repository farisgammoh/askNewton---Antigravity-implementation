...
Plans: ${JSON.stringify(shortlist.map(p=>({id:p.plan_id,name:p.name,metal:undefined, premium:p.monthly_premium, oop_max:p.oop_max, hits:p.in_network_hits})), null, 2)}`
